...
export async function renderFlatMinimalTicTacToe({ board = [
    ["X", "", "X"],
    ["", "O", "O"],
    ["O", "", "X"],
], } = {}) {
    ...
    ctx.arcTo(boardOffsetX + boardSize, boardOffsetY, boardOffsetX + boardSize, boardOffsetY + radius, radius);
    ctx.lineTo(boardOffsetX + boardSize, boardOffsetY + boardSize - radius);
    ctx.arcTo(boardOffsetX + boardSize, boardOffsetY + boardSize, boardOffsetX + boardSize - radius, boardOffsetY + boardSize, radius);
    ctx.lineTo(boardOffsetX + radius, boardOffsetY + boardSize);
    ctx.arcTo(boardOffsetX, boardOffsetY + boardSize, boardOffsetX, boardOffsetY + boardSize - radius, radius);
    ctx.lineTo(boardOffsetX, boardOffsetY + radius);
    ctx.arcTo(boardOffsetX, boardOffsetY, boardOffsetX + radius, boardOffsetY, radius);
    ctx.closePath();
