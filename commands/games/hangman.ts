...
import { generateCanvas } from "../../functions/render_hangman";
...
async function updateStats(c: ExpandedClient, playerId: ContactId, won: boolean) {
  ...
  const current: HangmanStats = (user.stats.hangman as unknown as HangmanStats) || {
    games: 0,
    wins: 0,
    draws: 0,
    losses: 0,
