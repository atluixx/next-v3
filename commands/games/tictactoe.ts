...
import { renderFlatMinimalTicTacToe } from "../../functions/render_ttt";
...
async function updateStats(c: ExpandedClient, winnerId: ContactId | "draw", players: Record<ContactId, Player>) {
